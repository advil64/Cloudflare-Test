  ...
  const links = [
    {
      name: 'My Resumé',
      url:
        'https://github.com/advil64/advil64/blob/master/Advith%20Chegu%20Rutgers%20Class%20of%202022.pdf',
    },
    { name: 'Linkedin', url: 'https://www.linkedin.com/in/achegu/' },
    { name: 'GitHub', url: 'https://github.com/advil64' },
  ]
...
class Title {
  async element(element) {
    element.setInnerContent('Advith Chegu')
  }
}
...
class Social {
  async element(element) {
    ...
    const social_images = [
      ...
      {
        link: 'https://www.instagram.com/advillion/',
        img:
    ...
    social_images.map(image =>
      element.append('<a href=' + image.link + '>' + image.img + '</a>', {
        html: true,
      }),
    )
  }
...
class ProfileIMG {
  async element(element) {
    element.setAttribute(
      'src',
      'https://pbs.twimg.com/profile_images/1310331982191222784/47d4Yuht_400x400.jpg',
    )
  }
}
